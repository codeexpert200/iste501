...
class HeartRate extends StatelessWidget {
  Future<Map<String, dynamic>> fetchLatestHeartRateData() async {
    ...
    if (response.statusCode == 200) {
      ...
      return {'patient_heart_rate_value': 0, 'patient_heart_rate_timestamp': ""};
    }
  }
      ...
      child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              if (snapshot.hasData) {
                int patient_heart_rate_value = snapshot.data!['patient_heart_rate_value'];
                String patient_heart_rate_timestamp = snapshot.data!['patient_heart_rate_timestamp'];
